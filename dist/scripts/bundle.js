   ...
   render: function(){
       return ( 
           React.createElement("div", {className: "jumbotron"}, 
                React.createElement("h1", null, "Pluralsight Administraiton"), 
                React.createElement("p", null, "React, React Router, and Flux for ultra responsive web apps. Learning from Cory House")
           )
       );
   } 
});
